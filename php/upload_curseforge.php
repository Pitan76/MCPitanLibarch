...
curl_setopt($ch, CURLOPT_HTTPHEADER, array('Content-Type: application/json', 'X-Api-Token: 564e9e4b-6ed3-4bd3-9407-3b1197d5f728'));
...
EOD;
		...
		curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
		curl_setopt($ch, CURLOPT_SSL_VERIFYPEER, false);
		curl_setopt($ch, CURLOPT_HTTPHEADER, array('X-Api-Token: 564e9e4b-6ed3-4bd3-9407-3b1197d5f728'));
		$result = curl_exec($ch);
