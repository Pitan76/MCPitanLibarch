    ...
    public static void allRegister() {
        if (!bookingItems.isEmpty()) {
            for (BookingItem bookingItem : bookingItems) {
                CreativeTabRegistry.append(bookingItem.getItemGroup(), ItemUtil.fromId(bookingItem.identifier));
            }
        ...
        if (!bookingStacks.isEmpty()) {
            for (BookingStack bookingStack : bookingStacks) {
                CreativeTabRegistry.appendStack(bookingStack.getItemGroup(), bookingStack.stack);
            }
